...
// LocalSandboxTheme implements the Theme interface with LocalSandbox brand colors.
// It provides both dark and light variants.
type LocalSandboxTheme struct {
	BaseTheme
}

// NewLocalSandboxTheme creates a new instance of the LocalSandbox theme.
func NewLocalSandboxTheme() *LocalSandboxTheme {
	// LocalSandbox color palette
	// Dark mode colors
...
func init() {
	// Register the LocalSandbox theme with the theme manager
	RegisterTheme("localsandbox", NewLocalSandboxTheme())
}
